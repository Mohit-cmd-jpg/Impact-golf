...
export async function POST(req: NextRequest) {
  try {
    ...
    if (fetchError || !draw) {
      return NextResponse.json({ error: 'No draft draw found to simulate.' }, { status: 404 });
    }
    ...
    // 3. Update the draw status and numbers
    ...
    // 4. Create some "Mock Winners" for this draw to show data
    // Pick 3 random users
